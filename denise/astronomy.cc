...
const Dstring format ("%Y.%m.%d %H:%M:%S");
const Dstring& str_0 = dtime_0.get_string (format, true);
const Dstring& str_1 = dtime_1.get_string (format, true);
const Dstring& str_m = dtm.get_string (format, true);
