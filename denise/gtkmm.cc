                           ...
                           const Console_2D& console_2d) const
{
   ...
   const Geodesy geodesy;
   const Multi_Journey mj (*this);
   const Real distance = mj.get_distance (geodesy);
   ...
   Multi_Journey multi_journey (mj, geodesy, d_distance);
   ...
   for (Simple_Polyline::iterator iterator = simple_polyline.begin ();
   ...
   for (Route::const_iterator i = begin (); i != end (); i++)
   {
      ...
      Journey journey = mj.get_journey (i);
